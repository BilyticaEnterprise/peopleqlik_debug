...
import 'package:peopleqlik_debug/Version1/views/BottomBarPages/RequestApprovalsPage/ApprovalsSubPages/ApprovalThreePages/rejected_approvals.dart';
...
import '../../../../../utils/Appbars/approvals_appbar.dart';
      ...
      child: Consumer<ApprovalCollector>(
          builder: (context, data, child) {
            return Row(
              children: [
                Expanded(
                    child: CustomTabsHeaderCircleElevated(data.approvalPageEnum == ApprovalPageEnum.pending?true:false,'${CallLanguageKeyWords.get(context, LanguageCodes.pending)}',pendingClick)
                ),
                Expanded(
                    child: CustomTabsHeaderCircleElevated(data.approvalPageEnum == ApprovalPageEnum.approve?true:false,'${CallLanguageKeyWords.get(context, LanguageCodes.approved)}',approveClick)
                ),
                Expanded(
                    child: CustomTabsHeaderCircleElevated(data.approvalPageEnum == ApprovalPageEnum.rejected?true:false,'${CallLanguageKeyWords.get(context, LanguageCodes.rejected)}',rejectClick)
                )
              ],
            );
          }
