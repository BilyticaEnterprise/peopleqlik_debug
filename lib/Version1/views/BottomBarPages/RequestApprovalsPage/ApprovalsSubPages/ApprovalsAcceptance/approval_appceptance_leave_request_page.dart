...
//       Provider.of<ApprovalsDetailCollector>(context,listen: false).approvalDetailMapper = widget.requestDetailData?.approvalDetailMapper;
...
//   ApprovalRequestDetailData(this.requestCode,this.managerId,this.show,this.approvalDetailMapper);
// }
//
