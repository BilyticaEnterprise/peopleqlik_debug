...
class MultiEmployeeSearchBody extends StatelessWidget {
  const MultiEmployeeSearchBody({Key? key}) : super(key: key);
  @override
...
class _SearchEmployeeListWidgetState extends State<SearchEmployeeListWidget> {
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          Flexible(
            child: Consumer<EmployeeOverTimeSearchBottomSheetListener>(
                            ...
                            child: ClipRRect(
                              ...
                              child: Material(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: (){
                                    HideShowKeyboard.hide(context);
                                    data.updateMultiSelectedIndex(index);
                                  },
                                  child: Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        TickIcon(check: data.multiEmployee!=null&&data.multiEmployee?.containsKey(data.teamDataList?[index].employeeCode)==true?true:false,),
  ...
  {
    Provider.of<EmployeeOverTimeSearchBottomSheetListener>(context,listen: false).searchEmployee(context,data);
  }
}
