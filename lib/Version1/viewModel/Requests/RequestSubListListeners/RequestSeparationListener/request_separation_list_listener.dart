...
class GetSeparationRequestListListener extends GetChangeNotifier
{
  ...
  async {
    ...
    ApiResponse apiResponse = await UseCaseGetApisUrlCaller().getSeparationListApiCall(context,'?PageNo=$page&PerPage=10&CompanyCode=${employeeInfoMapper.companyCode}&EmployeeCode=${employeeInfoMapper.employeeCode}');
