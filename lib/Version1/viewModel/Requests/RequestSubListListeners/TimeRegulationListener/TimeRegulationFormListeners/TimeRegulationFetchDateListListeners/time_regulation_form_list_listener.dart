...
class TimeRegulationFormFetchListListener extends GetChangeNotifier with GetPaginationClasses
{
  ...
  start(BuildContext context, ApiStatus status) async {
    ...
    ApiResponse apiResponse = await UseCaseGetApisUrlCaller().getMonthlyTimeRegulationApiCall(context, '?StatusID=${filterData?.statusId}&Fromdate=${filterData?.fromTime}&Todate=${filterData?.toTime}&PageNo=$page&PerPage=10&CompanyCode=${employeeInfoMapper.companyCode}&EmployeeCode=${employeeInfoMapper.employeeCode}');
