...
class TimeRegulationListListener extends GetChangeNotifier with GetPaginationClasses
{
  ...
  start(BuildContext context, ApiStatus status)async {
    ...
    ApiResponse apiResponse = await UseCaseGetApisUrlCaller().getTimeRegulationOfficeApiCall(context, page, companyCode: employeeInfoMapper.companyCode,employeeCode: employeeInfoMapper.employeeCode,typeId: typeId);
