...
class OvertimeAcceptanceRejectionDetailListener extends GetChangeNotifier
{
  ...
  void start(BuildContext context, ApprovalDetailMapper? approvalResultSet)async
  {
    ...
    ApiResponse apiResponse = await UseCaseGetApisUrlCaller().getOvertimeApprovalDetailsApiCall(context,'?ScreenID=${approvalResultSet?.screenID}&CompanyCode=${approvalResultSet?.companyCode}${AppConstants.getDocumentNumber(approvalResultSet!.documentNo!)}');
