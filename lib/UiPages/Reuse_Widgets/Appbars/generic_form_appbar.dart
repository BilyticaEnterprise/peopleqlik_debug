...
//
// class GenericFormAppBarWidget extends StatelessWidget with GoBack{
//   String title;
//   int? color;
//   String? profileImage;
//   int? selectedIndex;
...
//   GenericFormAppBarWidget(this.title,{this.openEmployeeSearch,this.color,this.hideEmployeeSearch,this.profileImage,this.selectedIndex,Key? key}) : super(key: key);
//   @override
...
//                               selectedIndex!=-1?
//                               CachedNetworkImage(
//                                   imageUrl: '${RequestType.profileUrl}${profileImage}',
