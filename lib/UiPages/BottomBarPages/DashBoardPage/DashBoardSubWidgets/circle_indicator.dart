...
class CircleSpinner extends StatefulWidget {
  ...
  int? color;
  IconData? icon;
  CircleSpinner({this.progressController,this.spinnerSize,this.text,this.percent = 1.0,this.color,this.icon,Key? key}) : super(key: key);
