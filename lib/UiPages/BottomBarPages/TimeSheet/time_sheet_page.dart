...
import 'package:peopleqlik_debug/UIBook/advanced_page_turn.dart';
import 'package:peopleqlik_debug/UiPages/BottomBarPages/TimeSheet/timesheet_panel_header.dart';
import 'package:peopleqlik_debug/UiPages/Reuse_Widgets/Appbars/app_bar.dart';
import 'package:peopleqlik_debug/UiPages/Reuse_Widgets/Appbars/time_sheet_app_bar.dart';
...
import 'package:peopleqlik_debug/src/double_formats.dart';
...
class TimeSheetPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   // final _controller = GlobalKey<AdvancedPageTurnState>();
    ...
    //                 else {
    //                   return NotAvailable(
    //                     GetVariable.internetAnim, '${CallSettingsKeyWords.get(context, LanguageCodes.stringsstr26)}',
