...
import 'package:peopleqlik_debug/UiPages/Reuse_Widgets/Appbars/request_add_appbar.dart';
      ...
      child: ClipRRect(
        ...
        child: Material(
          ...
          child: InkWell(
            ...
            onTap: (){
              Navigator.pushNamed(context, CurrentPage.RequestDetailPage,arguments: RequestDetailData(requestListDataList?.requestCode,requestDataTaker?.id));
            },
            child: Padding(
