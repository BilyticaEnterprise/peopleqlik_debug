...
import 'package:peopleqlik_debug/UiPages/BottomBarPages/Announcements/AnnouncementPanels/panel_body.dart';
import 'package:peopleqlik_debug/UiPages/BottomBarPages/Announcements/AnnouncementPanels/panel_header.dart';
...
import 'package:peopleqlik_debug/UiPages/Reuse_Widgets/html_widget.dart';
                ...
                body: Consumer<CheckInternetConnection>(
                    builder: (context, data, child) {
                      if (data.internetConnectionEnum ==
                        ...
                        return NotAvailable(
                          GetVariable.internetAnim, '${CallLanguageKeyWords.get(context, LanguageCodes.stringsstr26)}',
