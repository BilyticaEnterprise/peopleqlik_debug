...
class CustomTabsHeaderCircleElevated extends StatelessWidget {
  final String? header;
  final bool selected;
  final void Function() onClick;
  const CustomTabsHeaderCircleElevated(this.selected,this.header, this.onClick,{Key? key}) : super(key: key);
