    ...
    if(isLocalImage==false)
      {
        return CachedNetworkImage(
            ...
            imageBuilder: (context, imageProvider) => Container(
              ...
              child: ClipRRect(
                borderRadius: boxShape==BoxShape.rectangle?BorderRadius.all(Radius.circular(radius??15)):BorderRadius.all(Radius.circular(radius??100)),
                child: Material(
                ...
                child: ClipRRect(
                    ...
                    child: Material(
                        ...
                        child: InkWell(
                            onTap: onTap,
                            borderRadius: boxShape==BoxShape.rectangle?BorderRadius.all(Radius.circular(radius??15)):null,
                            child: Image.asset(GetAssets.avatar,fit: boxFit??BoxFit.cover,))),
                )
            )
        );
      }
          ...
          decoration: BoxDecoration(
            ...
            ClipRRect(
              ...
              child: vintageImage==true?ShaderMask(
                ...
                child: Image.asset(image??GetAssets.avatar,fit: boxFit??BoxFit.cover,),
              ):
              Image.asset(image??GetAssets.avatar,fit: boxFit??BoxFit.cover,),
            ):
