...
// import 'package:peopleqlik_debug/Version1/viewModel/TimeOffEnCashListners/time_off_list_collector.dart';
...
//
// class AppBarWidgetTimeOff extends StatelessWidget {
//   final String title;
//   final int? currentIndex;
//   const AppBarWidgetTimeOff(this.title, {this.currentIndex, Key? key}) : super(key: key);
//   @override
...
//                     children: [
//                       if(data.timeOffPageEnum != TimeOffPageEnum.holiday)...[
//                         SizedBox(
...
//                                             splashColor: const Color(MyColor.colorGrey0),
//                                             onTap: (){
//                                               Provider.of<TimeOffSlidingPanelController>(context,listen: false).updatePage(SliderWidgetEnum.employeeSearch);
//                                               Provider.of<TimeOffSlidingPanelController>(context,listen: false).panelController?.open();
//                                             },
...
//                               splashColor: const Color(MyColor.colorGrey0),
//                               onTap: (){
//                                 if(data.timeOffPageEnum == TimeOffPageEnum.summary) {
//                                   Provider.of<TimeOffSlidingPanelController>(context,listen: false).updatePage(SliderWidgetEnum.summary);
//                                   Provider.of<TimeOffSlidingPanelController>(context,listen: false).panelController?.open();
//                                 }
//                                 else if(data.timeOffPageEnum == TimeOffPageEnum.timeOff)
//                                 {
//                                   //Provider.of<EmployeeSearchController>(context,listen: false).clearEmployeeData();
//                                   Navigator.pushNamed(context, CurrentPage.TimeOffAddEdit).then((value){
//                                     Provider.of<EmployeeSearchController>(context,listen: false).justUpdatePage(EmployeeCalledForPage.timeOff);
...
//                                   padding: EdgeInsets.all(ScreenSize(context).heightOnly( 0.8)),
//                                   child: Icon(
//                                     data.timeOffPageEnum==TimeOffPageEnum.timeOff?MdiIcons.plus:Icons.keyboard_arrow_down_sharp,
