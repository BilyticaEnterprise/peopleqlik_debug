    ...
    return Stack(
      children: <Widget>[
        ...
        _DatePickerModeToggleButton(
          config: widget.config,
          mode: _mode,
          title: GetDateFormats().getDateTimeInDMMMY(_currentDisplayedMonthDate),
          onTitlePressed: () {
...
class _YearPickerState extends State<YearPicker> {
  ...
  Widget _buildYearItem(BuildContext context, int index) {
    ...
    //PrintLogs.printLogs('asasyeasasad $year ${widget.config.firstDate.year + index}');
    final bool isSelected = (widget.config.firstDate.year + index)==(widget.currentYear?.year);
   ...
   // PrintLogs.printLogs('sdasadas ${widget.selectedDates}');
    if (isSelected) {
      ...
      textColor =
          widget.config.selectedYearHighlightColor ?? colorScheme.primary;
    } else {
    ...
    if (isSelected) {
      decoration = BoxDecoration(
        color: widget.config.selectedYearHighlightColor ?? colorScheme.primary,
