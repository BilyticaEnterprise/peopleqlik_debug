...
class _HeaderDropDownFieldIsState extends State<_HeaderDropDownFieldIs> {
  ...
  void initState() {
    ...
    if(widget.dropDownDataType!=null&&widget.dropDownDataType?.list!=null&&widget.dropDownDataType!.list.isNotEmpty)
      {
  ...
  @override
  Widget build(BuildContext context) {
    if(widget.dropDownDataType!=null&&widget.dropDownDataType?.list!=null&&widget.clearAll!=null&&widget.clearAll==true)
    {
            ...
            enabled: widget.isEnabled??true,
                ...
                dropdownDecoratorProps: DropDownDecoratorProps(
                  ...
                  dropdownSearchDecoration: InputDecoration(
                    //constraints: BoxConstraints(maxHeight: ScreenSize(context).heightOnly(8.5),minHeight: ScreenSize(context).heightOnly(8.5)),
                    contentPadding: EdgeInsets.fromLTRB(ScreenSize(context).widthOnly(2.5), 0, ScreenSize(context).widthOnly( 1), 0),
                    fillColor: Color(widget.isEnabled==false?MyColor.colorBackgroundDark:MyColor.colorTransparent),
                    enabled: widget.isEnabled??true,
                ...
                onChanged: (dat)
                {
                  if(widget.dropDownDataType!=null&&widget.dropDownDataType?.list!=null&&widget.dropDownDataType?.dropDownTypeEnum!=null)
                    {
