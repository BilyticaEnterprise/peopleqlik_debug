...
class CalendarDatePicker2Config {
  CalendarDatePicker2Config({
    ...
    this.selectedYearHighlightColor,
  ...
  final Color? selectedYearHighlightColor;
  ...
  CalendarDatePicker2Config copyWith({
    ...
    Color? selectedYearHighlightColor,
    ...
    return CalendarDatePicker2Config(
      ...
      selectedYearHighlightColor: selectedYearHighlightColor ?? this.selectedYearHighlightColor,
