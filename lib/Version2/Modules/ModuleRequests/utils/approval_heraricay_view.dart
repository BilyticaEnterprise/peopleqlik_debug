...
class ApprovalHierarchyWidget extends StatelessWidget {
  // final List<ApprovalHistory>? uniqueList;
  final List<List<ApprovalList>>? approvalsList;
  const ApprovalHierarchyWidget(this.approvalsList, {Key? key}) : super(key: key);
...
class ListOfApprovalHistoryBody extends StatelessWidget {
  final List<ApprovalList>? approvalHistory;
