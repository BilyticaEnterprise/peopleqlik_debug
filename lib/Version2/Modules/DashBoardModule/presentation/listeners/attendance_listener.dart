...
import 'package:peopleqlik_debug/Version2/Modules/DashBoardModule/domain/model/attendance_mapper.dart';
...
import '../../domain/model/attendance_model.dart';
import '../../domain/model/dashboard_attendance_model.dart';
...
class PostAttendanceListener extends GetChangeNotifier with GetLoader
{
  ...
  async {
    PrintLogs.printLogs('apistatuss ${apiStatus}');
    ...
    if(apiResponse.apiStatus==ApiStatus.done)
    {
      ...
      checkSpinnerCirclePercent(context);
      apiStatus = ApiStatus.done;
      PrintLogs.printLogs('apistatusst ${apiStatus}');
      notifyListeners();
    }
    else
    {
