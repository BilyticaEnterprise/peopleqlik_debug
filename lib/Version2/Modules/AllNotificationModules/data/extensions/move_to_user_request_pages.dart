...
extension MoveToUserRequestPages on MoveUserToPagesFromNotificationsRepoImpl
{
  void moveToUserRequestPages(ApprovalRequestCommonModel? notificationReceivedModel) {
  ...
  {
    return AllRequestDetailMapper(screenID: notificationReceivedModel?.screenID.toString(), companyCode: notificationReceivedModel?.companyCode.toString(), documentNumber: notificationReceivedModel?.documentNo,isApprovalScreen: false);
  }
}